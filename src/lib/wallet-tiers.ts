export interface WalletTier {
  ...
  feeRate: number;
  color: string;
  cardStyle: string; // Outer glowing border gradient (VirtualCreditCard)
  bgStyle: string;   // Inner card face gradient background
  textStyle: string; // Card text/accent tint
}
...
export const WALLET_TIERS: WalletTier[] = [
  {
    ...
    cardStyle: "from-zinc-800/80 via-zinc-700/30 to-zinc-900 hover:from-zinc-500/40 hover:via-zinc-600/20 hover:to-zinc-600/30",
  ...
  },
  {
    ...
    cardStyle: "from-slate-700/80 via-slate-600/30 to-zinc-900 hover:from-slate-500/40 hover:via-slate-500/20 hover:to-slate-600/30",
  ...
  },
  {
    ...
    cardStyle: "from-amber-600/85 via-yellow-700/30 to-zinc-900 hover:from-amber-500/45 hover:via-yellow-600/25 hover:to-yellow-700/35",
    bgStyle: "from-amber-955/80 via-zinc-900/98 to-yellow-950/20",
  ...
  },
  {
    ...
    cardStyle: "from-cyan-600/85 via-teal-700/30 to-zinc-900 hover:from-cyan-500/45 hover:via-teal-600/25 hover:to-teal-700/35",
    bgStyle: "from-cyan-950/70 via-zinc-900/98 to-teal-950/20",
  ...
  },
  {
    ...
    color: "text-fuchsia-400 border-fuchsia-500/25 bg-fuchsia-950/20 shadow-[0_0_12px_rgba(217,70,239,0.2)]",
    cardStyle: "from-fuchsia-600/85 via-purple-700/30 to-zinc-900 hover:from-fuchsia-500/45 hover:via-purple-600/25 hover:to-indigo-700/35",
    bgStyle: "from-fuchsia-950/70 via-zinc-900/98 to-purple-950/20",
  ...
  },
  {
    ...
    color: "text-rose-455 border-rose-500/30 bg-rose-950/25 shadow-[0_0_15px_rgba(244,63,94,0.25)]",
    cardStyle: "from-rose-600/90 via-pink-700/35 to-zinc-950 hover:from-rose-500/50 hover:via-pink-600/30 hover:to-purple-700/40",
    bgStyle: "from-rose-950/70 via-zinc-900/98 to-purple-950/30",
