              ...
              <div className="flex items-center justify-between border-b border-zinc-850 pb-3 mb-3">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[8px] text-zinc-500 font-mono tracking-normal leading-tight">
                    Higher balances get lower trading fees.
                  </p>
                </div>
                <button
      ...
      <div className="flex flex-col gap-4">
        <div className={`flex flex-col gap-1.5 rounded-xl border p-3 font-semibold ${currentTier.color}`}>
          <div className="flex items-center justify-between">
            ...
            <span className={`font-display text-[11px] font-black uppercase tracking-widest ${currentTier.color.split(" ")[0]}`}>
              {currentTier.name}
            </span>
          </div>
        ...
        {!nextTier && (
          <div className="rounded-xl border border-emerald-500/20 bg-emerald-950/10 p-3 text-center">
            <span className="text-[10px] font-black uppercase tracking-wider text-emerald-400">
              Highest tier reached — lowest fee rate.
            </span>
